...
def predict_action(req: PredictionRequest):
    ...
    if prediction == 2:
        ...
        action = "SELL 50%"
        reason = f"Solid net margin (₹{req.net_earning:.0f}/q) with manageable decay risk. Staggered 50% liquidation locks in cash flow while hedging against future price spikes."
    else:
        action = "HOLD"
    ...
    return {
        ...
        "reasoning": reason,
        "model_type": "Explainable Random Forest (100 Trees, Depth 7)"
    }
